...
public class ApplicationInsightsJsonLayoutTests {
    ...
    public void topLevelIncludesRequiredFields() {
        ...
        assertThat(jsonMap, Matchers.<String, Object>hasEntry(ApplicationInsightsJsonLayout.TIMESTAMP_PROP_NAME, String.valueOf(TIMESTAMP_VALUE))); // there is no timestamp format specified, so it just uses the raw long value.
    ...
    public void addsDataFromFinders() {
        ...
        assertThat((Map<String, Object>) jsonMap.get(ApplicationInsightsJsonLayout.CUSTOM_FIELDS_PROP_NAME), Matchers.<String, Object>hasEntry(key, value));
    }
